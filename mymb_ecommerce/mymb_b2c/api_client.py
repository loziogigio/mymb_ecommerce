...
class MymbAPIClient:
	...
	def __init__(
		...
		self.base_url = url or f"https://{self.settings.mymb_b2c_site}"
	...
	def create_update_item(self, item_dict: JsonDict, update=False) -> Tuple[JsonDict, bool]:
		"""Create/update item on mymb_b2c.

		ref: https://documentation.mymb_b2c.com/docs/createoredit-itemtype.html
		"""
	...
	def get_sales_order(self, order_code: str) -> Optional[JsonDict]:
		...
		ref: https://documentation.mymb_b2c.com/docs/saleorder-get.html
		"""
	...
	def search_sales_order(
		...
		ref: https://documentation.mymb_b2c.com/docs/saleorder-search.html
		"""
		body = {
			"status": status,
			"channel": channel,
	...
	def get_inventory_snapshot(
		...
		ref: https://documentation.mymb_b2c.com/docs/inventory-snapshot.html
		"""
	...
	def bulk_inventory_update(self, facility_code: str, inventory_map: Dict[str, int]):
		"""Bulk update inventory on mymb_b2c using SKU and qty.

		The qty should be "total" quantity.
		ref: https://documentation.mymb_b2c.com/docs/adjust-inventory-bulk.html
		"""
	...
	def create_invoice_and_assign_shipper(self, shipping_package_code: str, facility_code: str):
		...
		ref: https://documentation.mymb_b2c.com/docs/pos-shippingpackage-createinvoice-allocateshippingprovider.html
		"""
		body = {
	...
	def create_invoice_and_label_by_shipping_code(
		...
		ref: https://documentation.mymb_b2c.com/docs/create_invoiceandlabel_by_shippingpackagecode.html
		"""
		body = {
			"shippingPackageCode": shipping_package_code,
	...
	def get_sales_invoice(
		...
		ref: https://documentation.mymb_b2c.com/docs/invoice-getdetails.html
		"""
		extra_headers = {"Facility": facility_code}
		response, status = self.request(
	...
	def update_shipping_package(
		...
		"""Update shipping package dimensions and other details on MymbAPIClient.

		ref: https://documentation.mymb_b2c.com/docs/shippingpackage-edit.html
		"""
	...
	def create_and_close_shipping_manifest(
		...
		"""Create and close the shipping manifest in MymbAPIClient

		Ref: https://documentation.mymb_b2c.com/docs/pos-shippingmanifest-create-close.html"""
	...
	def search_shipping_packages(
		...
		"""Search shipping packages on mymb_b2c matching specified criterias.

		Ref: https://documentation.mymb_b2c.com/docs/pos-shippingpackage-search.html"""
		body = {
			"statuses": statuses,
			"channelCode": channel,
			"updatedSinceInMinutes": updated_since,
	...
	def create_import_job(
		...
		args:
		        job_name: import job code string specified by mymb_b2c
...
def _utc_timeformat(datetime) -> str:
	""" Get datetime in UTC/GMT as required by MymbAPIClient"""
